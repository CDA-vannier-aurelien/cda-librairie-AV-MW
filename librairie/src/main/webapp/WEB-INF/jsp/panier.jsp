                    ...
                    <div class="col-lg-6">
                        ...
                        <div class="p-4">
                            ...
                            <div class="input-group mb-4 border rounded-pill p-2">
                                <input type="text" placeholder="Code coupon" aria-describedby="button-addon3" class="form-control border-0">
                        ...
                        <div class="bg-light rounded-pill px-4 py-3 text-uppercase font-weight-bold">Contacter le service après-vente</div>
                        <div class="p-4">
                            <p class="font-italic mb-4">Si vous avez des informations à transmettre à notre équipe, enregistrez les dans le cadre suivant</p>
                            <textarea name="" cols="30" rows="2" class="form-control"></textarea>
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <div class="bg-light rounded-pill px-4 py-3 text-uppercase font-weight-bold">Prix de votre commande </div>
                        <div class="p-4">
                            <p class="font-italic mb-4">Les frais de livraison et le prix des articles est basé sur les articles que vous avez sélectionné.</p>
                            <ul class="list-unstyled mb-4">
                                <li class="d-flex justify-content-between py-3 border-bottom"><strong class="text-muted">Prix total de vos articles </strong><strong>$390.00</strong></li>
                            ...
                            </ul><a href="#" class="btn btn-dark rounded-pill py-2 btn-block">Valider la commande</a>
                        </div>
                    </div>
                </div>
...
<footer class="footer text-faded text-center py-5" style="background-color: rgb(238,244,247);position: relative;">
    <div class="container">
        <p class="m-0 small" style="color: rgb(102,109,112);">Copyright&nbsp;©&nbsp;Brand 2020</p>
    </div>
</footer>
