        ...
        <div class="collapse navbar-collapse" id="navbarResponsive">
            <ul class="nav navbar-nav mx-auto">
                ...
                <c:if test="${empty sessionScope.user }">
                    <li class="nav-item" role="presentation"><a class="nav-link"
                                                                data-toggle="modal" data-target="#modalLRForm">Login</a>
                    </li>
                </c:if>
                <c:if test="${!empty sessionScope.user }">
            ...
            <div class="container">
                ...
                <div class="row py-5 p-4 bg-white rounded shadow-sm">
                    <div class="col-lg-6">
                        ...
                        <div
                                class="bg-light rounded-pill px-4 py-3 text-uppercase font-weight-bold">Nous conctacter
                        </div>
                        <div class="p-4">
                            <p class="font-italic mb-4">Vous pouvez ajouter vos questions pour notre équipe dans le
                                cadre suivant</p>
                    ...
                    <div class="col-lg-6">
                        ...
                        <div class="p-4">
                            ...
                            <form action="commander" method="post">
                                ...
                                <button id="button-addon4" type="submit" class="btn btn-dark px-4 rounded-pill">
